...
40  rombint_corr_2d=g0
    ...
    if (Ini%Read_Logical('use_corrprior',.false.)) then
        ...
        this%z_bins(6) = Ini%Read_Double('param[void_z4]') !NHmod 
        this%z_bins(7) = Ini%Read_Double('param[void_z5]')
        this%z_bins(8) = Ini%Read_Double('param[void_z6]')
        this%z_bins(9) = Ini%Read_Double('param[void_z7]')
        this%z_bins(10) = Ini%Read_Double('param[void_z8]')
        this%z_bins(11) = Ini%Read_Double('param[void_z9]')
        this%z_bins(12) = Ini%Read_Double('param[void_z10]')
        this%z_bins(13) = Ini%Read_Double('param[void_z11]')
        this%z_bins(14) = Ini%Read_Double('param[void_z12]')
        this%z_bins(15) = Ini%Read_Double('param[void_z13]')
        this%z_bins(16) = Ini%Read_Double('param[void_z14]')
        this%z_bins(17) = Ini%Read_Double('param[void_z15]')
        this%z_bins(18) = Ini%Read_Double('param[void_z16]')
        this%z_bins(19) = Ini%Read_Double('param[endred]')
    ...
    if ( CMB%void_mean_fiducial == 2 ) then !SPmod: fiducial as mean of neighbours bins
      ...
      i=1
      void_mean = (CMB%void_qV(i) + CMB%void_qV(i+1))/2._mcp !NH why is this different to the end bin?
