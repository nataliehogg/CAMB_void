!NH this file contains the switch from theta to H0 as originally implemented by M Martinelli
    ...
    !NHmod: added AstroParameterization to align with planck2018 cosmomc -- but does it conflict with the H0 parametrisation
    ! originally implemented by MM?
...
!----------------------------------------------------------------------------------
        !NHmod: added the extra derived params; old version commented below
...
!------------------------------------------------------------------------------------
!NHmod: added all below to align with planck2018 cosmomc
   ...
   !Astro parameterization using H0, omegam, omegab...
    ...
    !call this%SetTheoryParameterNumbers(9,last_power_index) !NHmod: change no. of params?
    call this%SetTheoryParameterNumbers(23+2*CosmoSettings%void_n+2,last_power_index)
